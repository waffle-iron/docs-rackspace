...
texinfo_documents = [
  ('index', 'Tools', 'Rackspace Metrics Developer Guide',
   'Rackspace', 'Tools', 'Learn about Rackspace-related terms.',
   'Miscellaneous'),
]
