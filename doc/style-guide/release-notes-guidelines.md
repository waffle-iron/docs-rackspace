...
- Use the punctuation guidelines for lists at [Writing list items](../a-l-style-guidelines.html#writing-list-items).

- As needed, use the [text formatting guidelines](../m-z-style-guidelines.html#text-formatting-guidelines).
