...
- [Messages](#messages)
- [Names](#names)
- [Notes and other notation types](#notes-and-other-notation-types)
- [Numbers](#numbers)
- [Parameters](#parameters)
- [Placeholder (variable) text](#placeholder-variable-text)
- [Plurals](#plurals)
- [Product names and version numbers](#product-names-and-version-numbers)
- [Punctuation](#punctuation)
- [Symbols](#symbols)
- [Tables](#tables)
- [Tasks and procedures](#tasks-and-procedures)
...
Cross-references | See [Links and cross-references](../a-l-style-guidelines.html#links-and-cross-references). | Not applicable
...
Email addresses | See [Email addresses](../a-l-style-guidelines.html#email-addresses). | Not applicable
