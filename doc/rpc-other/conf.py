...
project = 'RPC team documentation'
...
htmlhelp_basename = 'docs-rpc-team'
...
latex_documents = [('index', 'docs-rpc-team.tex',
...
man_pages = [
    ('index', 'docs-rpc-team',
     'RPC team documentation', ['Rackspace'], 1)]
...
texinfo_documents = [('index', 'docs-rpc-team',
                      'RPC team documentation',
                      'Rackspace', 'docs-rpc-team',
